"use strict";export class GuiAccordion extends HTMLElement{constructor(){var e;super(),this.collapsibles=[],this.attachShadow({mode:"open"});const l=String.raw`<style>
        ...
        `;this.template_fragment=document.createRange().createContextualFragment(t),(e=this.shadowRoot)===null||e===void 0||e.appendChild(this.template_fragment.cloneNode(!0)),this.header_el=this.shadowRoot.querySelector(".header"),this.content_el=this.shadowRoot.querySelector(".content")}connectedCallback(){this.closed&&(this.header_el.setAttribute("closed","true"),this.content_el.setAttribute("closed","true"),this.header_el.classList.add("closed"),this.content_el.classList.add("closed")),this.header_el.addEventListener("click",e=>{if(this.header_el.classList.toggle("closed"),this.content_el.classList.toggle("closed"),this.header_el.classList.contains("closed"))this.closed=!0;else{this.closed=!1;let l=new Event("open");this.dispatchEvent(l)}})}static get observedAttributes(){return["title","closed"]}set title(e){this._title=e}attributeChangedCallback(e,l,t){var a;switch(e){case"title":this.title=t;let s=(a=this.shadowRoot)===null||a===void 0?void 0:a.querySelector(".header>span");s.innerText=t;break;case"closed":t===""?this.closed=!0:t==="true"?this.closed=!0:t==="false"&&(this.closed=!1),this.closed?(this.header_el.classList.add("closed"),this.content_el.classList.add("closed")):(this.header_el.classList.remove("closed"),this.content_el.classList.remove("closed"));break;default:break}}}customElements.define("gui-collapsible",GuiCollaspible);class h extends HTMLElement{constructor(){super(),this._label="Label",this._value="",this._selectedIndex=0,this.attachShadow({mode:"open"});const e=String.raw`<style>
            .wrapper{
                padding : 0.5em;
                display : flex;
                flex-direction : row;
